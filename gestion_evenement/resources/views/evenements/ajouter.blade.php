...
@section('mon_contenu')
    <div class="flex items-center justify-center h-screen">
        <form class=" max-w-screen-md mx-auto border-solid border-2 rounded-md py-3 px-7 shadow-lg my-8" action="/evenement/ajouter" method="POST" enctype="multipart/form-data" novalidate>
            @csrf
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-8">
                    <div class="sm:col-span-8">
                        <label for="libelle" class="block text-sm font-medium leading-6 text-gray-900">Titre
                            evenement</label>
                        <div class="mt-2">
                            <input type="text" name="libelle" id="libelle" autocomplete="libelle" required
                        ...
                        <div class="col-span-full">
                            ...
                            <div class="mt-2">
                                <textarea id="description" name="description" rows="2"
                                    class="px-2 block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"></textarea>
                            </div>
                        </div>
                        ...
                        <div class="sm:col-span-3">
                            ...
                            <div class="mt-2">
                                <input type="date" name="date_evenement" id="date_evenement"
                                    autocomplete="date_evenement" required
                                    class="form-input px-2 block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                            </div>
                        </div>
