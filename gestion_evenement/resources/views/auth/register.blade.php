...
<div class="flex items-center justify-center h-screen">
    ...
    <form class=" border-solid border-2 rounded-md p-6 shadow-lg" action="/register/user" method="POST" novalidate>
        @csrf
...
<header class="bg-white shadow">
      <div class="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
        ...
        <div class=" space-x-8 border-b border-gray-900/10 pb-12">
            <h2 class="text-base font-semibold leading-7 text-gray-900 text-center pt-2.5">Remplir et enregister pour créer un nouveau compte </h2>
            {{-- <p class="mt-1 text-sm leading-6 text-gray-600">Remplir et Enrégister ce formulaire pour créer un nouveau compte </p> --}}
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                ...
                <div class="sm:col-span-3">
                    <label for="motdepasse" class="block text-sm font-medium leading-6 text-gray-900">Mot de passe </label>
                    <div class="mt-2">
                ...
                <div class="sm:col-span-3">
                    <label for="motdepasseconf" class="block text-sm font-medium leading-6 text-gray-900">Confirmer Mot de passe</label>
                    <div class="mt-2">
                        <input type="password" name="motdepasseconf" id="motdepasseconf"  required
                            class="form-input px-2 block w-full rounded-md border-0 py-1.5 text-gray-700 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6">
                    </div>
                </div>
